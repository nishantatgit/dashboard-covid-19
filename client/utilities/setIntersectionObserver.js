const setIntersectionObserver = ( options  = {} , target, onTargetEntry, onTargetLeave  ) => {
  const {
    rootMargin = '0px',
    threshold = 0,
    root = null
  ...
  const observer = new IntersectionObserver(wrappedCallback, { root : scrollArea, rootMargin, threshold});
